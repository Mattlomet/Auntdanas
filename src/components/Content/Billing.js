...
function Billing(){
  ...
  <div>
      <h1 className="title">Billing for Mom & Baby?</h1>
      <h2 className="subtitle">
      When deciding to bill the insurance company for both the Mother and the Baby, there are some special considerations. OF COURSE, we SHOULD be billing for both, as there are two patients in the room, but the current coding allowed and timing of the visit comes into question. 
      </h2>
